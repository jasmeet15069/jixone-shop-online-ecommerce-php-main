						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="#"><i class="fa fa-phone"></i>+91 9891475624</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>jasmeet.15069@gmail.com</a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-6 text-center" style="margin-top:80px;">
							...
							<span class="copyright">
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by
								 <a href="https://github.com/jasmeet15069/" target="_blank">Jasmeet Sethi</a> 
								 <a href="https://github.com/sushant6830" target="_blank">Sushant Kumar</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
